...
class InvalidGridLocationError(ValueError):
    ...
    def __init__(self, gl: Any, message: Optional[str]="The provided GridLocation is not valid."):
        self.gl: Any = gl
...
class InvalidSymbolError(TypeError):
    ...
    def __init__(self, symbol: Any, message: Optional[str]="The provided symbol is not valid. Expected a string."):
...
class InvalidMoveError(ValueError):
    ...
    def __init__(self, gl: GridLocation, message: Optional[str]="The attempted move is not allowed."):
...
class InvalidInstanceError(TypeError):
    ...
    def __init__(self, instance: type, expected_type: type, message: Optional[str]=None):
        self.instance = instance
        self.expected_type = expected_type
        if message is None:
            message:str = (f"The provided instance is not of type {expected_type.__name__}."
